...
# S3 Bucket vars:
S3_BUCKET_NAME='whales-bucket-name'
# Codecommit repository name:
CODECOMMIT_REPO_NAME='whales-repo-name'
# Codecommit repository description:
CODECOMMIT_REPO_DESCRIPTION='a whales repo description'
# CODEBUILD_NAME 
CODEBUILD_NAME='whales-codebuild-name'
# Codebuild template path
CODEBUILD_TEMPLATE_PATH=../infrastructure/codebuild/create-build.yaml
# Codepipeline name:
CODEPIPELINE_NAME='whales-pipeline-name'
# Codepipeline path:
...
LOCAL_REPO_FOLDER=./COPIED_SITES
